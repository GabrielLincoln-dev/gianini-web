...
const dict = {
  pt: {
    ...
    hero: {
      ...
      title: "Sites que convertem em Arujá.",
      titleAccent: "Presença digital que constrói autoridade no Alto Tietê.",
      sub: "Somos uma agência de desenvolvimento web em Arujá — SP, especializada em sites institucionais, blogs, landing pages e web apps sob medida para empresas, comércios, escolas, clínicas e profissionais autônomos da cidade e de toda a região. Unimos design exclusivo, performance real e SEO técnico focado no público local, para que seu negócio seja encontrado no Google por quem procura seus serviços em Arujá, Santa Isabel, Itaquaquecetuba, Guarulhos e Mogi das Cruzes.",
    ...
    why: {
      ...
      sub: "Cada projeto é pensado para gerar autoridade local, atrair o público certo da sua cidade e converter visitantes em clientes de verdade. Trabalhamos com foco em SEO local, tempo de carregamento, acessibilidade e uma identidade visual que diferencie sua marca da concorrência em Arujá e região.",
      items: [
        ...
        { t: "SEO local e técnico", d: "Estrutura semântica, dados estruturados, metadados e conteúdo otimizados para buscas do tipo 'em Arujá', 'perto de mim' e Google Meu Negócio." },
        { t: "Autoridade digital", d: "Conteúdo e arquitetura que posicionam sua marca como referência no seu setor dentro do Alto Tietê." },
    ...
    local: {
      ...
      p1: "A Gianini Web nasceu em Arujá com a missão de oferecer, para as empresas locais, o mesmo padrão de qualidade técnica encontrado nas melhores agências da capital. Atendemos clientes em toda a cidade — Centro, Jardim Rincão, Arujamérica, Arujazinho, Vila Flórida, Jordanópolis, Chácaras Arujá e demais bairros — além dos municípios vizinhos: Santa Isabel, Itaquaquecetuba, Guarulhos, Mogi das Cruzes, Suzano e Poá.",
      p2: "Se você tem um comércio, clínica, escritório, escola, restaurante, imobiliária, indústria ou presta serviços autônomos em Arujá, um site profissional é o primeiro passo para ser encontrado no Google, transmitir credibilidade e transformar visitantes em clientes. Cuidamos de tudo: registro de domínio, hospedagem, e-mails profissionais, integração com WhatsApp, Instagram, Google Meu Negócio e criação de conteúdo focado nas buscas da sua cidade.",
      servicesTitle: "O que fazemos",
      services: [
        "Criação de sites institucionais em Arujá",
        "Landing pages para campanhas locais (Google Ads e Meta Ads)",
        ...
        "SEO local — Arujá, Alto Tietê e Grande São Paulo",
    ...
    form: {
      ...
      title: "Conte sua dor. Devolvemos uma solução digital sob medida.",
  ...
  en: {
    ...
    why: {
      ...
      sub: "Every project is engineered to build local authority, attract the right audience in your city and convert visitors into real customers — with strong local SEO, fast load times, accessibility and a visual identity that stands out from the competition in Arujá and the wider Alto Tietê area.",
      items: [
        ...
        { t: "Digital authority", d: "Content and architecture that position your brand as a reference in your industry across Alto Tietê." },
    ...
    local: {
      ...
      p2: "If you run a shop, clinic, office, school, restaurant, real estate, industry or offer independent services in Arujá, a professional website is your first step to be found on Google, build credibility and turn visitors into paying customers. We handle everything: domain registration, hosting, professional email, WhatsApp / Instagram / Google Business Profile integration and content creation tuned to the searches happening in your city.",
    ...
    form: {
      kicker: "Let's talk",
      title: "Tell us the pain. We'll bring a tailored digital solution.",
